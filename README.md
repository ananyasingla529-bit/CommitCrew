...
- **Person 1**(Ananya Singla: ([@ananyasingla529-bit](https://github.com/ananyasingla529-bit))) — Backend, API, deployment
- **Person 2**(Charu Malhotra: ([@charu-blabla](https://github.com/charu-blabla))) — Interview strategy, prompt engineering, persona design and validation
- **Person 3**(Bhakti Gupta: ([@bhaktigupta51-ai](https://github.com/bhaktigupta51-ai))) — Frontend/UI, candidate data integration
